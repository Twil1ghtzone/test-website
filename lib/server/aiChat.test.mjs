...
try {
  const manipuliert = C.loadSession(cookieValue);
  C.decryptedHistory(manipuliert);
} catch {
  warfFehler = true;
}
ok("Manipulierter Ciphertext lässt sich nicht entschlüsseln (GCM-Auth-Tag greift)", warfFehler);
